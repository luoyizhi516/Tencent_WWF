...
def main():
    image_base,label_base='data/top14-part1-transformed/allset/images/','data/top14-part1-transformed/allset/labels/'
    ...
    train_folder_img,train_folder_txt='data/top14-part1-transformed/conservation/train/images/','data/top14-part1-transformed/conservation/train/labels/'
    test_folder_img,test_folder_txt='data/top14-part1-transformed/conservation/val/images/','data/top14-part1-transformed/conservation/val/labels/'
