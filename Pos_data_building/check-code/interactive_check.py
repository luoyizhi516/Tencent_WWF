...
def main():
    ...
    txt_path=r'D:\WWF_Det\WWF_Det\Drop_txt\top14-part3/check7600-7700.txt'
    with open(txt_path, 'w') as f:

        for i in img_list[7600:7700]:
            img_dir=base+i
            print(img_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_dir', type=str, default=r'D:\WWF_Det\WWF_Data\Pos_Data\top14-part3\allset\visualizations/', help='dataset_store_dir')
