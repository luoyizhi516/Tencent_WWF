...
def main():
    ...
    txt_path=r'D:\WWF_Det\WWF_Det\Drop_txt\rest-part2/check2000-2100.txt'
    with open(txt_path, 'w') as f:
        for i in img_list[2000:2100]:
            img_dir=base+i
            print(img_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_dir', type=str, default=r'D:\WWF_Det\WWF_Data\Pos_Data\rest-part2\allset\visualizations/', help='dataset_store_dir')
