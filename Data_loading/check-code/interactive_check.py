...
def main():
    ...
    txt_path=r'D:/WWF/data-check-list\check-list-part2/check0-33.txt'
    with open(txt_path, 'w') as f:

        for i in img_list[0:33]:
            img_dir=base+i
            print(img_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_dir', type=str, default='D:/top14-sup-transformed/visualization/', help='dataset_store_dir')
