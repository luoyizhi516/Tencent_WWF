...
def extract_frames(src_path,target_path):
    ...
    for video_name in tqdm(os.listdir(src_path)):
        ...
        os.system("ffmpeg" + " -i" +' ' +filename +" -r" +" 1" +' -q:v 2 -f image2'+' '+ dest)
def main():
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base', type=str, default=r'D:\WWF_Det\WWF_Data\Raw_Data\top14-p1-p2/', help='dataset_store_dir')
